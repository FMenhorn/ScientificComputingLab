...
%FIG_LABELER labels the given figures from figure_array and saves them as
%picture files
% INPUT:
...
%     set(gcf,'units','normalized','outerposition',[0 0 1 1]); % obsolete,
%     now contained in figure creation
